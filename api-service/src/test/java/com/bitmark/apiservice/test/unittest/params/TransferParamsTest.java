...
public class TransferParamsTest extends BaseTest {
    ...
    private static Stream<Arguments> createSignedParamsJson()
            throws IOException {
        final TransferParams params1 = new TransferParams(
                Address.fromAccountNumber(
                        "eujeF5ZBDV3qJyKeHxNqnmJsrc9iN7eHJGECsRuSXvLmnNjsWX"),
                "20df48ef393aa1f62d9ea6ff496fb4b5c9029eefc1dc888d8df7b03c1794ee82"
        );
        final TransferParams params2 = new TransferParams(
                Address.fromAccountNumber(
                        "eujeF5ZBDV3qJyKeHxNqnmJsrc9iN7eHJGECsRuSXvLmnNjsWX"),
                "ad22ae9c46bdf53b7b8b6f520650e1aaa84960739cd7f7461cd3a8695e24cc96"
        );
    ...
    public void testConstructTransferParamsWithLink_InvalidParams_ErrorIsThrow(
            Address owner,
            String link
    ) {
        assertThrows(
                ValidateException.class,
                () -> new TransferParams(owner, link)
        );
    }

...
public class ApiServiceTest extends BaseTest {
    ...
    public void testRegisterAsset_NewAsset_CorrectResponseIsReturn(File asset)
        ...
        Map<String, String> metadata = new HashMap<String, String>() {{
            ...
            put(
                    "description",
                    "Temporary File create from java api service test"
            );
        }};
    ...
    public void testRegisterAsset_ExistedAsset_CorrectResponseIsReturn(
            @TemporaryFile("This is an existing file on Bitmark Block chain")
                    File asset
    )
            throws Throwable {
        Map<String, String> metadata = new HashMap<String, String>() {{
    ...
    public void testQueryAssetById_ExistedAssetId_CorrectResponseIsReturn()
        ...
        AssetQueryBuilder builder =
                new AssetQueryBuilder().registeredBy(ADDRESS1.getAddress())
                        .limit(1);
        List<AssetRecord> assets =
                await(callback -> ApiService.getInstance()
                        .listAssets(builder.build(), callback));
    ...
    @Test
    public void testQueryAssets_ByAtAndTo_CorrectResponseIsReturn()
            throws Throwable {
        int limit = 10;
        long at = 5;
        AssetQueryBuilder builder =
                new AssetQueryBuilder().limit(limit)
                        .at(at)
                        .to("earlier")
                        .pending(true);
        List<AssetRecord> assets =
    ...
    public void testIssueBitmark_OwnedMultipleBitmark_CorrectSuccessResponseIsReturn(
        ...
        RegistrationResponse registrationResponse =
                await(callback -> ApiService.getInstance().registerAsset(
                        registrationParams,
                        callback
                ));
    ...
    public void testTransferBitmark_NotOwnedBitmark_CorrectErrorResponseIsReturn()
        ...
        BitmarkQueryBuilder builder =
                new BitmarkQueryBuilder().ownedBy(ADDRESS2.getAddress())
                        .pending(true);
        BitmarkRecord bitmark = findBitmark(
                builder,
                b -> !b.isOffer() && b.getStatus() == SETTLED
    ...
    public void testReplyOffer_AcceptOffer_CorrectSuccessResponseIsReturn()
        ...
        String offerId =
                await(callback -> ApiService.getInstance()
                        .offerBitmark(offerParams, callback));
        ...
        GetBitmarkResponse response =
                await(callback -> ApiService.getInstance()
                        .getBitmark(bitmark.getId(), false,
                                callback
                        ));
    ...
    public void testQueryBitmarkByIdWithAsset_ExistedBitmarkId_CorrectResponseIsReturn()
        ...
        GetBitmarksResponse bitmarksResponse =
                await(callback -> ApiService.getInstance()
                        .listBitmarks(builder.build(), callback));
        assertFalse(
    ...
    public void testQueryTransactionWithoutAsset_ExistedTxId_CorrectResponseIsReturn()
        ...
        TransactionQueryBuilder builder =
                new TransactionQueryBuilder().ownedBy(ADDRESS1.getAddress())
                        .limit(1);
        ...
        GetTransactionResponse getTransactionResponse =
                await(callback -> ApiService.getInstance().getTransaction(
                        txId,
                        false,
                        callback
                ));
    ...
    @Test
    public void testQueryTransactions_ByAtAndTo_CorrectResponseIsReturn()
            throws Throwable {
        int limit = 10;
        long at = 5;
        TransactionQueryBuilder builder =
    ...
    @Test
    public void testQueryTransactions_ByBlockNumber_CorrectResponseIsReturn()
            throws Throwable {
        long blockNumber = 10;
        TransactionQueryBuilder builder =
                new TransactionQueryBuilder().referencedBlockNumber(blockNumber)
                        .pending(true);
        GetTransactionsResponse getTransactionsResponse =
                await(callback -> ApiService.getInstance()
                        .listTransactions(builder.build(), callback));
    ...
    public void testRegisterWsToken__ValidTokenReturn() throws Throwable {
        ...
        String token =
                await(callback -> ApiService.getInstance()
                        .registerWsToken(params, callback));
        assertNotNull(token);
    }

...
public class TransferResponseParamsTest extends BaseTest {
    ...
    private static Stream<OfferRecord> createValidOffer()
        ...
        reflectionSet(
                offer1,
                new Pair<>("id", "c9b9911a4-4237-419b-9862-00957d7c4618"),
        ...
        reflectionSet(
                offer2,
                new Pair<>("id", "39de1800-ecec-4dea-8425-d2a87e468ace"),
    ...
    private static Stream<Arguments> createSignedAcceptParamsJson()
        ...
        reflectionSet(
                offer1,
                new Pair<>("id", "9b9911a4-4237-419b-9862-00957d7c4618"),
                new Pair<>("record", record1)
        );
        ...
        reflectionSet(
                offer2,
                new Pair<>("id", "196b12ee-770d-48b3-8402-32c72810c297"),
                new Pair<>("record", record2)
        );
        final TransferResponseParams params1 = TransferResponseParams.accept(
                offer1);
        final TransferResponseParams params2 = TransferResponseParams.accept(
                offer2);
    ...
    private static Stream<Arguments> createUnsignedNotAcceptParamsJson()
        ...
        final TransferResponseParams params1 = TransferResponseParams.cancel(
                offer1,
                "eujeF5ZBDV3qJyKeHxNqnmJsrc9iN7eHJGECsRuSXvLmnNjsWX"
        );
        final TransferResponseParams params2 = TransferResponseParams.reject(
                offer2);
    ...
    private static Stream<Arguments> createValidParamsHeader()
        ...
        final TransferResponseParams params2 = TransferResponseParams.accept(
                offer2);
        final TransferResponseParams params3 = TransferResponseParams.cancel(
                offer3,
                "ec6yMcJATX6gjNwvqp8rbc4jNEasoUgbfBBGGyV5NvoJ54NXva"
        );
        params3.setSigningKey(Ed25519KeyPair.from(
                HEX.decode(
        ...
        return Stream.of(
                Arguments.of(params1, 1536742580935L, header1),
                Arguments.of(
                        params2,
                        1536742638942L,
                        header2
    ...
    public void testConstructTransferResponseParams_ValidOfferRecord_CorrectInstanceIsReturn(
        ...
        assertDoesNotThrow(() -> TransferResponseParams.cancel(
                offer,
                "eujeF5ZBDV3qJyKeHxNqnmJsrc9iN7eHJGECsRuSXvLmnNjsWX"
        ));
    }
    ...
    public void testConstructAcceptTransferResponseParams_InvalidOfferRecord_ErrorIsThrow() {
        ...
        assertThrows(
                ...
                () -> TransferResponseParams.accept(null)
        );
    }
    ...
    public void testConstructRejectTransferResponseParams_InvalidOfferRecord_ErrorIsThrow() {
        ...
        assertThrows(
                ValidateException.class,
                () -> TransferResponseParams.reject(null)
        );
    }
    ...
    public void testBuildRequestHeader_ValidCondition_CorrectHeaderIsReturn(
        ...
        assertTrue(header.toString()
                .equalsIgnoreCase(params.buildHeaders(time).toString()));
    }

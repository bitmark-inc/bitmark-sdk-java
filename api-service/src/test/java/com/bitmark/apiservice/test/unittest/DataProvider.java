...
public class DataProvider {
    ...
    public static final KeyPair KEY_PAIR_1 = Ed25519KeyPair.from(
            HEX.decode(PUBLIC_KEY_1),
    ...
    public static final KeyPair KEY_PAIR_2 = Ed25519KeyPair.from(
            HEX.decode(PUBLIC_KEY_2),
    ...
    public static final KeyPair KEY_PAIR_3 = Ed25519KeyPair.from(
            HEX.decode(PUBLIC_KEY_3),
    ...
    public static final KeyPair KEY_PAIR_4 = Ed25519KeyPair.from(
            HEX.decode(PUBLIC_KEY_4),

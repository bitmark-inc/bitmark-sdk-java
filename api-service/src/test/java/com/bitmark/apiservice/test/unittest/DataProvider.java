...
public class DataProvider {
    ...
    public static final KeyPair KEY_PAIR_1 = StandardKeyPair.from(HEX.decode(PUBLIC_KEY_1),
    ...
    public static final KeyPair KEY_PAIR_2 = StandardKeyPair.from(HEX.decode(PUBLIC_KEY_2),
    ...
    public static final KeyPair KEY_PAIR_3 = StandardKeyPair.from(HEX.decode(PUBLIC_KEY_3),
    ...
    public static final KeyPair KEY_PAIR_4 = StandardKeyPair.from(HEX.decode(PUBLIC_KEY_4),

...
public class DataProvider {
    ...
    public static final KeyPair KEY1 = Ed25519KeyPair.from(
            HEX.decode(
    ...
    public static final KeyPair KEY2 = Ed25519KeyPair.from(
            HEX.decode(
    ...
    public static final Address ADDRESS3 =
            Address.fromAccountNumber(
                    "eY7ddmQcwDSUtPybUsDXyZtMeDcKEnGq36yVkeFuMMmwP6NhcV");

    public static final KeyPair KEY3 = Ed25519KeyPair.from(
            HEX.decode(

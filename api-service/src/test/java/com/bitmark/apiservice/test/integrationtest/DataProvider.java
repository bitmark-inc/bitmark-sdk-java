...
public class DataProvider {
    ...
    public static final KeyPair KEY1 = StandardKeyPair.from(HEX.decode(
    ...
    public static final KeyPair KEY2 = StandardKeyPair.from(HEX.decode(
    ...
    public static final KeyPair KEY3 = StandardKeyPair.from(HEX.decode(

    ...
    private static Stream<Arguments> createInvalidNameMetadataAddress() {
        return Stream.of(Arguments.of("", new HashMap<String, String>() {{
                ...
                Arguments.of("Asset1", new HashMap<String, String>() {{
                    put("name", "Tarketios and his two older companions were skilled metalworkers from a region some two hundred miles to the north, where the hills were rich with iron, copper, and lead." +

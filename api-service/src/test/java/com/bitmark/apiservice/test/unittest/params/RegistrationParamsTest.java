...
import static com.bitmark.apiservice.test.utils.FileUtils.*;
import static org.junit.jupiter.api.Assertions.*;

public class RegistrationParamsTest extends BaseTest {

    private static Stream<Arguments> createValidNameMetadata() {
    ...
    private static Stream<Arguments> createInvalidNameMetadata() {
        return Stream.of(
                Arguments
                        .of(
                                "This is too longggggggggggggggggggggggggggggggggggggggggggggggggggggggg name",
    ...
    private static Stream<Arguments> createDataFingerprint()
            throws IOException {
        final byte[] data1 = getResourceAsBytes("asset1.txt");
        final byte[] data2 = getResourceAsBytes("asset2.txt");
        return Stream.of(
                Arguments.of(
                        data1,
                        "016e627499a0a1db93e04c4b32cc8dce498c549ac69300ce6ff46e4a2c225929be3a6081f5b072da50cb819ae297aa154430c5be7b046f834692f581f9cf2d4fb0"
    ...
    private static Stream<Arguments> createValidParamsJson()
            throws IOException {
        ...
        final RegistrationParams params1 = new RegistrationParams(
                "name",
                new HashMap<String,
                        String>() {{
                    put("author", "test");
        ...
        final RegistrationParams params2 = new RegistrationParams(
                "name",
                new HashMap<String,
                        String>() {{
                    put("author", "test");
        ...
        params1.setFingerprintFromFile(getResourceFile("asset1.txt"));
        params2.setFingerprintFromFile(getResourceFile("asset2.txt"));
    ...
    @ParameterizedTest
    @MethodSource("createValidNameMetadata")
    public void testConstructRegistrationParams_ValidAllParams_ValidInstanceIsReturn(
            String name,
            Map<String, String> metadata
    ) {
        assertDoesNotThrow(() -> new RegistrationParams(name, metadata));
    }

    @ParameterizedTest
    @MethodSource("createInvalidNameMetadata")
    public void testConstructRegistrationParams_InvalidParams_ErrorIsThrow(
            String name,
            Map<String, String> metadata
    ) {
        assertThrows(
                ValidateException.class,
                () -> new RegistrationParams(name, metadata)
        );
    }

    @ParameterizedTest
    @MethodSource("createFileFingerprint")
    public void testSetFingerprintFromFile_ValidFile_CorrectFingerprintIsReturn(
            File file,
        ...
        String fingerprint = params.setFingerprintFromFile(file);
    ...
    public void testSetFingerprintFromFile_InvalidFile_ErrorIsThrow(File file) {
        assertThrows(
                ValidateException.class,
                () -> new RegistrationParams(ASSET_NAME, METADATA)
                        .setFingerprintFromFile(file)
        );
    }

    @ParameterizedTest
    @MethodSource("createDataFingerprint")
    public void testSetFingerprintFromData_ValidData_CorrectFingerprintIsReturn(
            byte[] data,
            String expectedFingerprint
    ) {
        final RegistrationParams params = new RegistrationParams(
    ...
    public void testSign_NoCondition_CorrectSignatureIsReturn(
    ...
    public void testToJson_NoCondition_CorrectJsonIsReturn(
            RegistrationParams params,
            String expectedJson
    ) {

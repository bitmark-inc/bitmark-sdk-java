...
public class ShareGrantRecord implements Record, Validation {
    ...
    public boolean isValid() {
        return id != null && !id.isEmpty() && shareId != null && !shareId.isEmpty() && HEX
                .decode(shareId).length == Sha3256.HASH_BYTE_LENGTH && Address.isValidAccountNumber(
                from) && Address.isValidAccountNumber(to) && record != null && record
                .isValid() && createdAt != null && !createdAt.isEmpty() && status != null && !status
                .isEmpty();
    }
    ...
    public static class Record implements Validation {
        ...
        @Override
        public boolean isValid() {
            return quantity >= 0 && owner != null && !owner.isEmpty() && Address
                    .isValidAccountNumber(owner) && receiver != null && !receiver
                    .isEmpty() && Address.isValidAccountNumber(receiver) && beforeBlock > 0 && signature != null && !signature
                    .isEmpty();
        }
    }

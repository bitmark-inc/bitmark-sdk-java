 ...
 */
package com.bitmark.sdk.bcbip39wrapper.bip39;

import android.annotation.SuppressLint;
import com.bitmark.sdk.bcbip39wrapper.error.LibraryLoaderException;
...
public class LibraryLoader {
    ...
    private static final String BIP39_LIBRARY = "bip39jni";
    ...
    private static void loadNativeLib() throws IOException {
        ...
        try {
            ...
            try {
                ...
                System.loadLibrary(BIP39_LIBRARY);
            }
        } catch (IOException e) {
    ...
    private static String getLibName() {
        switch (OS.getOS()) {
            case WINDOWS:
                return "bip39jni.dll";
            case DARWIN:
                return "libbip39jni.dylib";
            case LINUX:
                return "libbip39jni.so";
            case ANDROID:
                return "libbip39jni.so";
            default:
                throw new LibraryLoaderException(

...
public class SequenceIterateByteArrayTest extends BaseTest {
    ...
    public void testConstructInstance_NullByteArray_ErrorIsThrow() {
        assertThrows(
                ValidateException.NullValueError.class,
    ...
    public void testConstructInstance_NonNullByteArray_CorrectInstanceCreated(
            byte[] input
    ) {
    ...
    public void testNextByteArray_ValidLength_CorrectResultIsReturn(
            byte[] bytes, int[] lengths,
            List<byte[]> expectedBytes
    ) {
        final SequenceIterateByteArray byteArray = new SequenceIterateByteArray(
                bytes);
    ...
    public void testNextByteArray_InvalidLength_ErrorIsThrow(
            byte[] bytes,
            int length
    ) {
        final SequenceIterateByteArray byteArray = new SequenceIterateByteArray(
    ...
    public void testNextByteArray_EmptyLength_RemainingByteArrayIsReturn(
            byte[] bytes,
            byte[] expectedResult
    ) {
        final SequenceIterateByteArray byteArray = new SequenceIterateByteArray(
    ...
    private static Stream<Arguments> createByteArrayLengthByteArray() {
        return Stream.of(
                Arguments.of(
                        new byte[]{0x55, 0x7F, 0x3A, 0x5F, 0x23, 0x34, 0x17},
                        new int[]{2, 3, 1},
                        new ArrayList<byte[]>() {{
    ...
    private static Stream<Arguments> createByteArrayByteArray() {
        return Stream.of(
                ...
                Arguments.of(
                        new byte[]{0x12, 0x54, 0x4F, 0x5B, 0x5F, 0x2F},

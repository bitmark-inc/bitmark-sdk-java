...
public class MigrationTest extends BaseTest {
    ...
    public void testMigration_Valid24Words_CorrectValuesReturn(String[] twentyFourWords)
            throws Throwable {
        Pair<Account, List<String>> pair = await(callback -> Migration.migrate(
                twentyFourWords,
                callback
        ), TIMEOUT);
    ...
    private static Stream<Arguments> createValid24Words() {
        return Stream.of(
                Arguments.of((Object) ("abuse tooth riot whale dance dawn armor patch tube sugar edit clean guilt person lake height tilt wall prosper episode produce spy artist account")
                        .split(" ")),
                Arguments.of((Object) ("accident syrup inquiry you clutch liquid fame upset joke glow best school repeat birth library combine access camera organ trial crazy jeans lizard science")
                        .split(" "))
        );
    }
    ...
    private static Stream<Arguments> createInvalid24Words() {
        return Stream.of(
                ...
                Arguments.of((Object) ("abuse tooth riot whale dance dawn armor patch tube sugar edit clean guilt person lake height tilt wall prosper episode produce spy artist accountant")
                        .split(" ")),
                Arguments.of((Object) (

...
int crypto_secretbox(unsigned char *dst_cipher, const unsigned char *src_plain,
                    unsigned long long plain_len, const unsigned char *nonce,
                    const unsigned char *secret_key);

int crypto_secretbox_open(unsigned char *src_plain, const unsigned char *dst_cipher,
                          unsigned long long cipher_len, const unsigned char *nonce,
                          const unsigned char *secret_key);

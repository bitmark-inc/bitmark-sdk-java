...
public class Ed25519Test extends BaseCryptoTest {
    ...
    @ParameterizedTest
    @ValueSource(strings = {
            "f2b15c7200965a7e6827f80749657a3fe655980c1f03f2ecb475cfcf31f6ca31",
    ...
    public void testGenerateKeyPairFromSeed_ValidSeed_ValidKeyPairIsReturn(
            String seedHex
    ) {
    ...
    @ParameterizedTest
    @ValueSource(strings = {
            "f2b15c7200965a7e6827f80749657a3fe655980c1f03f2ecb475cfcf31f6ca",
            "d9b7a41748db4da24f7dadc0d0a8c87e6c",
            "731ea25f"
    })
    public void testGenerateKeyPairFromSeed_InvalidSeedLength_ErrorIsThrow(
            String seedHex
    ) {
        assertThrows(
                ValidateException.InvalidLength.class,
                () -> Ed25519.generateKeyPairFromSeed(HEX.decode(seedHex))
        );
    }

    @ParameterizedTest
    @CsvSource({
                       "c65246785ff374c03de0171019df4ac977174bf8db6f89a944246132a967f49e, f2b15c7200965a7e6827f80749657a3fe655980c1f03f2ecb475cfcf31f6ca31c65246785ff374c03de0171019df4ac977174bf8db6f89a944246132a967f49e",
    ...
    public void testGetKeyPairFromPrivateKey_ValidPrivateKey_ValidKeyPairIsReturn(
            String publicKeyHex,
    ...
    @ParameterizedTest
    @ValueSource(strings = {
            "c65246785ff374c03de0171019df4ac977174bf8db6f89a944246132a967f49e",
    ...
    public void testGetKeyPairFromPrivateKey_InvalidPrivateKey_ErrorIsThrow(
            String privateKeyHex
    ) {
        assertThrows(
                ValidateException.InvalidLength.class,
                () -> Ed25519.getKeyPair(HEX.decode(privateKeyHex))
        );
    }

    @ParameterizedTest
    @CsvSource({
                       "f2b15c7200965a7e6827f80749657a3fe655980c1f03f2ecb475cfcf31f6ca31c65246785ff374c03de0171019df4ac977174bf8db6f89a944246132a967f49e, f2b15c7200965a7e6827f80749657a3fe655980c1f03f2ecb475cfcf31f6ca31",
    ...
    public void testGetSeedFromPrivateKey_ValidPrivateKey_ValidSeedIsReturn(
            String privateKeyHex,
            String seedHex
    ) {
        final byte[] privateKey = HEX.decode(privateKeyHex);
    ...
    @ParameterizedTest
    @ValueSource(strings = {
            "f2b15c7200965a7e6827f80749657a3fe655980c1f03f2ecb475",
            "d9b7a41748db4da24f7dad",
            "731ea25f9b"
    })
    public void testGetSeedFromPrivateKey_InvalidPrivateKey_ErrorIsThrow(String privateKeyHex) {
        assertThrows(
                ValidateException.InvalidLength.class,
                () -> Ed25519.getSeed(HEX.decode(privateKeyHex))
        );
    }
    ...
    public void testGetSeedFromHexPrivateKey_ValidHexPrivateKey_ValidSeedIsReturn(
    ...
    public void testGetSeedFromHexPrivateKey_InvalidHexPrivateKey_ErrorIsThrow(
            String privateKeyHex
    ) {
        assertThrows(
                ValidateException.InvalidLength.class,
                () -> Ed25519.getSeed(privateKeyHex)
        );
    }

    @ParameterizedTest
    @CsvSource({
                       "4269746d61726b53444b, f2b15c7200965a7e6827f80749657a3fe655980c1f03f2ecb475cfcf31f6ca31c65246785ff374c03de0171019df4ac977174bf8db6f89a944246132a967f49e, 51c7cf9e80ee62418189a6a323e4a994bceb1108c7e9ce61d74d3179128aa8de3681e00f3f17f23de34e0c97882103d20f27cf641863d1c903a3a4a5bd9fed05",
    ...
    public void testSignMessageByByteArrayPrivateKey_ValidByteArrayPrivateKey_ValidSignatureIsReturn(
            String hexMessage,
            String hexPrivateKey,
            String hexSignature
    ) {
    ...
    @ParameterizedTest
    @CsvSource({
                       "4269746d61726b53444b, f2b15c72f00965a7e6827f80749657a3fe655980c1f03f2ecb47abc1234251234bcfdacbcafefeaefcbfeadcdfebcbcdeaf56734523643456235436436bc2353634cdef23234a234abbbba235235124235",
                       "4a61766153444b, d9b7a41748db4da24f7dad",
                       "4269746d61726b496e546865467574757265, 745a"
               })
    public void testSignMessageByByteArrayPrivateKey_InvalidByteArrayPrivateKey_ErrorIsThrow(
            String hexMessage,
            String hexPrivateKey
    ) {
        final byte[] message = HEX.decode(hexMessage);
    ...
    public void testSignMessageByHexPrivateKey_ValidHexPrivateKey_ValidSignatureIsReturn(
            String message,
            String privateKey,
            String signature
    ) {
    ...
    public void testSignMessageByHexPrivateKey_InvalidHexPrivateKey_ErrorIsThrow(
            String message,
            String privateKey
    ) {
        assertThrows(
    ...
    @ParameterizedTest
    @CsvSource({
                       "4269746d61726b53444b, c65246785ff374c03de0171019df4ac977174bf8db6f89a944246132a967f49e, 51c7cf9e80ee62418189a6a323e4a994bceb1108c7e9ce61d74d3179128aa8de3681e00f3f17f23de34e0c97882103d20f27cf641863d1c903a3a4a5bd9fed05",
    ...
    public void testVerifySignatureByByteArrayPublicKey_ValidByteArrayPublicKey_ValidResultIsReturn(
            String hexMessage,
            String hexPublicKey,
            String hexSignature
    ) {
    ...
    @ParameterizedTest
    @CsvSource({
                       "4269746d61726b53444b, c65246785ff374c03de0171019df4ac977174bf8db6f89a944246132a967f49e, 51c7cf9e3e4a994bceb108c7e9ce61d74d3179128aa8de3681e00f3f17f23de34e0c97882103d20f27cf641863d1c903a3a4a5bd9fed05",
    ...
    public void testVerifySignatureByByteArrayPublicKey_InvalidPublicKey_ErrorIsThrow(
            String hexMessage,
            String hexPublicKey,
            String hexSignature
    ) {
    ...
    public void testVerifySignatureByHexPublicKey_ValidHexPublicKey_ValidResultIsReturn(
            String message,
            String publicKey,
            String signature
    ) {
    ...
    public void testVerifySignatureByHexPublicKey_InvalidHexPublicKey_ErrorIsThrow(
            String message,
            String publicKey,
            String signature
    ) {

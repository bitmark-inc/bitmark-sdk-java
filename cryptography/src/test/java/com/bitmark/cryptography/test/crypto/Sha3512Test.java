...
public class Sha3512Test extends BaseCryptoTest {
    ...
    @ParameterizedTest
    @CsvSource({
                       "BitmarkSDK, f5ad8d9b58e122d2d229f86eaa5d276496a5a3da19d53c887a23f81955a3d07266b50a896d332abc1d1845850311e50570cb56ee507b89ec18bc91edc34c1059",
    ...
    @ParameterizedTest
    @CsvSource({
                       "4269746d61726b53444b, f5ad8d9b58e122d2d229f86eaa5d276496a5a3da19d53c887a23f81955a3d07266b50a896d332abc1d1845850311e50570cb56ee507b89ec18bc91edc34c1059",
    ...
    @ParameterizedTest
    @CsvSource({
                       "BitmarkSDK, 85a33da78d99a4394ff1f73fc561401f87e369606fa15ade52c4fff332e868b690b950056fcb1eebb8ab94f1e853f34d8c5b9d7df10e9a3090393e465032cfec, S",
    ...
    public void testHashByteArrayOnceCustomOffsetAndLength_InvalidOffsetOrLength_ErrorIsThrow(
        ...
        assertThrows(
                ...
                () -> Sha3512.hash(input, offset, length)
        );
    }

    @ParameterizedTest
    @CsvSource({
                       "BitmarkSDK, 5126292a6cca69105cc803d94082c22465d4af77e90f40d9a9d2b1cbc2d7412fae521ca0d4eada60906d517fb1dc144d685f193b11ab7a7cea02e47e5a6e0f47",
    ...
    @ParameterizedTest
    @CsvSource({
                       "4269746d61726b53444b, 5126292a6cca69105cc803d94082c22465d4af77e90f40d9a9d2b1cbc2d7412fae521ca0d4eada60906d517fb1dc144d685f193b11ab7a7cea02e47e5a6e0f47",
    ...
    @ParameterizedTest
    @CsvSource({
                       "BitmarkSDK, 32b91d3d93f73ec0587250870495d6a3d8226ddd279e9efd59694df15e28158b8262a2b91faa73ec4a2a2356a529bf9a6e49936fa0d24d568951f33313238700, S",
    ...
    public void testHashByteArrayTwiceCustomOffsetAndLength_InvalidOffsetOrLength_ErrorIsThrow(
        ...
        assertThrows(
                ValidateException.class,
                () -> Sha3512.hashTwice(input, offset,
                        length
                )
        );
    }
    ...
    @ParameterizedTest
    @CsvSource({
                       "32b91d3d93f73ec0587250870495d6a3d8226ddd279e9efd59694df15e28158b8262a2b91faa73ec4a2a2356a529bf9a6e49936fa0d24d568951f33313238700, 32b91d3d93f73ec0587250870495d6a3d8226ddd279e9efd59694df15e28158b8262a2b91faa73ec4a2a2356a529bf9a6e49936fa0d24d568951f33313238700",
    ...
    @ParameterizedTest
    @CsvSource({
                       "32b91d3d93f73ec0587250870495d6a3d8226ddd279e9efd59694df15e28158b8262a2b91faa73ec4a2a2356a529bf9a6e49936fa0d24d568951f33313238700, 31b91d3d93f73ec0587250870495d6a3d8226ddd279e9efd59694df15e28158b8262a2b91faa73ec4a2a2356a529bf9a6e49936fa0d24d568951f33313238700",

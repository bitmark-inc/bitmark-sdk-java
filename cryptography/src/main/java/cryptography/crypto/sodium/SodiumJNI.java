...
public class SodiumJNI {
    ...
    public final static native int crypto_secretbox_open_easy(byte[] jarg1, byte[] jarg2,
                                                              int jarg3, byte[] jarg4,
                                                              byte[] jarg5);

    public final static native int crypto_secretbox(byte[] jarg1, byte[] jarg2, int jarg3,
                                                    byte[] jarg4, byte[] jarg5);

    public final static native int crypto_secretbox_open(byte[] jarg1, byte[] jarg2, int jarg3,
                                                         byte[] jarg4, byte[] jarg5);
    ...
    public final static native int crypto_sign(byte[] jarg1, int[] jarg2, byte[] jarg3, int jarg4
            , byte[] jarg5);

    public final static native int crypto_sign_open(byte[] jarg1, int[] jarg2, byte[] jarg3,
    ...
    public final static native int crypto_onetimeauth_verify(byte[] jarg1, byte[] jarg2,
                                                             int jarg3, byte[] jarg4);
    ...
    public final static native int crypto_kx_client_session_keys(byte[] jarg1, byte[] jarg2,
                                                                 byte[] jarg3, byte[] jarg4,
                                                                 byte[] jarg5);

    public final static native int crypto_kx_server_session_keys(byte[] jarg1, byte[] jarg2,
                                                                 byte[] jarg3, byte[] jarg4,
                                                                 byte[] jarg5);
    ...
    public final static native int crypto_aead_chacha20poly1305_encrypt_detached(byte[] jarg1,
                                                                                 byte[] jarg2,
                                                                                 int[] jarg3,
                                                                                 byte[] jarg4,
                                                                                 int jarg5,
    ...
    public final static native int crypto_aead_chacha20poly1305_decrypt_detached(byte[] jarg1,
                                                                                 byte[] jarg2,
                                                                                 byte[] jarg3,
                                                                                 int jarg4,
                                                                                 byte[] jarg5,
    ...
    public final static native int crypto_aead_xchacha20poly1305_ietf_encrypt(byte[] jarg1,
                                                                              int[] jarg2,
                                                                              byte[] jarg3,
                                                                              int jarg4,
                                                                              byte[] jarg5,
    ...
    public final static native int crypto_aead_xchacha20poly1305_ietf_decrypt(byte[] jarg1,
                                                                              int[] jarg2,
                                                                              byte[] jarg3,
                                                                              byte[] jarg4,
                                                                              int jarg5,
    ...
    public final static native int crypto_auth_hmacsha512256(byte[] jarg1, byte[] jarg2,
                                                             int jarg3, byte[] jarg4);
    ...
    public final static native int crypto_box_curve25519xsalsa20poly1305(byte[] jarg1,
    ...
    public final static native int crypto_generichash_blake2b(byte[] jarg1, int jarg2,
                                                              byte[] jarg3, int jarg4,
                                                              byte[] jarg5, int jarg6);

    public final static native int crypto_generichash_blake2b_salt_personal(byte[] jarg1,
                                                                            int jarg2,
                                                                            byte[] jarg3,
                                                                            int jarg4,
                                                                            byte[] jarg5,
    ...
    public final static native int crypto_pwhash(byte[] jarg1, int jarg2, byte[] jarg3, int jarg4
            , byte[] jarg5, int jarg6, int jarg7, int jarg8);

    public final static native int crypto_pwhash_str(byte[] jarg1, byte[] jarg2, int jarg3,
                                                     int jarg4, int jarg5);
    ...
    public final static native int crypto_shorthash_siphash24(byte[] jarg1, byte[] jarg2,
                                                              int jarg3, byte[] jarg4);
    ...
    public final static native int crypto_sign_ed25519_open(byte[] jarg1, int[] jarg2,
                                                            byte[] jarg3, int jarg4, byte[] jarg5);
    ...
    public final static native int crypto_stream_chacha20_xor(byte[] jarg1, byte[] jarg2,
                                                              int jarg3, byte[] jarg4,
                                                              byte[] jarg5);
    ...
    public final static native int crypto_stream_salsa20_xor(byte[] jarg1, byte[] jarg2,
    ...
    public final static native int crypto_stream_xsalsa20_xor(byte[] jarg1, byte[] jarg2,
                                                              int jarg3, byte[] jarg4,
                                                              byte[] jarg5);
    ...
    public final static native int crypto_secretstream_xchacha20poly1305_init_push(byte[] jarg1,
                                                                                   byte[] jarg2,
                                                                                   byte[] jarg3);

    public final static native int crypto_secretstream_xchacha20poly1305_push(byte[] jarg1,
                                                                              byte[] jarg2,
                                                                              int[] jarg3,
                                                                              byte[] jarg4,
                                                                              int jarg5,
    ...
    public final static native int crypto_secretstream_xchacha20poly1305_init_pull(byte[] jarg1,
                                                                                   byte[] jarg2,
                                                                                   byte[] jarg3);

    public final static native int crypto_secretstream_xchacha20poly1305_pull(byte[] jarg1,
                                                                              byte[] jarg2,
                                                                              int[] jarg3,
                                                                              byte[] jarg4,
                                                                              byte[] jarg5,
    ...
    public final static native int crypto_box_curve25519xchacha20poly1305_keypair(byte[] jarg1,
                                                                                  byte[] jarg2);

    public final static native int crypto_box_curve25519xchacha20poly1305_beforenm(byte[] jarg1,
                                                                                   byte[] jarg2,
                                                                                   byte[] jarg3);
    ...
    public final static native int crypto_box_curve25519xchacha20poly1305_detached(byte[] jarg1,
                                                                                   byte[] jarg2,
                                                                                   byte[] jarg3,
                                                                                   int jarg4,
                                                                                   byte[] jarg5,
    ...
    public final static native int crypto_box_curve25519xchacha20poly1305_easy(byte[] jarg1,
                                                                               byte[] jarg2,
                                                                               int jarg3,
                                                                               byte[] jarg4,
                                                                               byte[] jarg5,

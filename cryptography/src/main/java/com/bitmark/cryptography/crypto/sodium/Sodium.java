...
public class Sodium {
    ...
    public static int crypto_secretbox_open_easy(byte[] dst_plain, byte[] src_cipher,
        ...
        return SodiumJNI.crypto_secretbox_open_easy(dst_plain, src_cipher, cipher_len, nonce,
                secret_key);
    }

    public static int crypto_secretbox(byte[] dst_cipher, byte[] src_plain, int plain_len,
                                       byte[] nonce, byte[] secret_key) {
        return SodiumJNI.crypto_secretbox(dst_cipher, src_plain, plain_len, nonce, secret_key);
    }

    public static int crypto_secretbox_open(byte[] src_plain, byte[] dst_cipher, int cipher_len,
                                            byte[] nonce, byte[] secret_key) {
        return SodiumJNI.crypto_secretbox_open(src_plain, dst_cipher, cipher_len, nonce,
                secret_key);
    }
    ...
    public static int crypto_secretbox_detached(byte[] dst_cipher, byte[] mac, byte[] src_plain,
        ...
        return SodiumJNI.crypto_secretbox_detached(dst_cipher, mac, src_plain, plain_len, nonce,
                secretkey);
    }

    public static int crypto_secretbox_open_detached(byte[] dst_plain, byte[] src_cipher,
                                                     byte[] mac, int cipher_len, byte[] nonce,
                                                     byte[] secretkey) {
        return SodiumJNI.crypto_secretbox_open_detached(dst_plain, src_cipher, mac, cipher_len,
                nonce, secretkey);
    }
    ...
    public static int crypto_box_easy(byte[] dst_cipher, byte[] src_plain, int plain_len,
                                      byte[] nonce, byte[] remote_public_key,
                                      byte[] local_private_key) {
        return SodiumJNI.crypto_box_easy(dst_cipher, src_plain, plain_len, nonce,
    ...
    public static int crypto_box_open_easy(byte[] dst_plain, byte[] src_cipher, int cipher_len,
                                           byte[] nonce, byte[] remote_public_key,
                                           byte[] local_private_key) {
        return SodiumJNI.crypto_box_open_easy(dst_plain, src_cipher, cipher_len, nonce,
                remote_public_key, local_private_key);
    }

    public static int crypto_box_detached(byte[] dst_cipher, byte[] dst_mac, byte[] src_plain,
                                          int plain_len, byte[] nonces, byte[] remote_public_key,
                                          byte[] local_private_key) {
        return SodiumJNI.crypto_box_detached(dst_cipher, dst_mac, src_plain, plain_len, nonces,
                remote_public_key, local_private_key);
    }

    public static int crypto_box_open_detached(byte[] dst_plain, byte[] src_cipher,
                                               byte[] src_mac, int cipher_len, byte[] nonce,
                                               byte[] remote_public_key, byte[] local_private_key) {
        return SodiumJNI.crypto_box_open_detached(dst_plain, src_cipher, src_mac, cipher_len,
                nonce, remote_public_key, local_private_key);
    }
    ...
    public static int crypto_box_easy_afternm(byte[] dst_cipher, byte[] src_plain, int plain_len,
        ...
        return SodiumJNI.crypto_box_easy_afternm(dst_cipher, src_plain, plain_len, nonce,
                shared_key);
    }

    public static int crypto_box_open_easy_afternm(byte[] dst_plain, byte[] src_cipher,
                                                   int cipher_len, byte[] nonce,
                                                   byte[] shared_key) {
        return SodiumJNI.crypto_box_open_easy_afternm(dst_plain, src_cipher, cipher_len, nonce,
                shared_key);
    }

    public static int crypto_box_detached_afternm(byte[] dst_cipher, byte[] dst_mac,
                                                  byte[] src_plain, int plain_len, byte[] nonce,
                                                  byte[] shared_key) {
        return SodiumJNI.crypto_box_detached_afternm(dst_cipher, dst_mac, src_plain, plain_len,
                nonce, shared_key);
    }

    public static int crypto_box_open_detached_afternm(byte[] dst_plain, byte[] src_cipher,
                                                       byte[] src_mac, int cipher_len,
                                                       byte[] nonce, byte[] shared_key) {
        return SodiumJNI.crypto_box_open_detached_afternm(dst_plain, src_cipher, src_mac,
                cipher_len, nonce, shared_key);
    }
    ...
    public static int crypto_box_open(byte[] dst_msg, byte[] src_cipher, int cipher_len,
        ...
        return SodiumJNI.crypto_box_open(dst_msg, src_cipher, cipher_len, src_nonce, src_pub,
                src_secret);
    }
    ...
    public static int crypto_box_open_afternm(byte[] dst_msg, byte[] src_cipher, int cipher_len,
                                              byte[] src_nonce, byte[] src_key) {
        return SodiumJNI.crypto_box_open_afternm(dst_msg, src_cipher, cipher_len, src_nonce,
                src_key);
    }
    ...
    public static int crypto_sign(byte[] dst_signed_msg, int[] signed_msg_len, byte[] src_msg,
        ...
        return SodiumJNI.crypto_sign(dst_signed_msg, signed_msg_len, src_msg, msg_len,
                local_private_key);
    }

    public static int crypto_sign_open(byte[] dst_msg, int[] msg_len, byte[] src_signed_msg,
                                       int signed_msg_len, byte[] remote_public_key) {
        return SodiumJNI.crypto_sign_open(dst_msg, msg_len, src_signed_msg, signed_msg_len,
                remote_public_key);
    }
    ...
    public static int crypto_sign_verify_detached(byte[] src_signature, byte[] src_msg,
                                                  int msg_len, byte[] remote_public_key) {
        return SodiumJNI.crypto_sign_verify_detached(src_signature, src_msg, msg_len,
                remote_public_key);
    }
    ...
    public static int crypto_generichash(byte[] dst_hash, int dst_len, byte[] src_input,
        ...
        return SodiumJNI.crypto_generichash(dst_hash, dst_len, src_input, input_len, src_key,
                key_len);
    }
    ...
    public static int crypto_kx_client_session_keys(byte[] rx, byte[] tx, byte[] client_pk,
                                                    byte[] client_sk, byte[] server_pk) {
        return SodiumJNI.crypto_kx_client_session_keys(rx, tx, client_pk, client_sk, server_pk);
    }

    public static int crypto_kx_server_session_keys(byte[] rx, byte[] tx, byte[] server_pk,
                                                    byte[] server_sk, byte[] client_pk) {
    ...
    public static int crypto_aead_chacha20poly1305_encrypt(byte[] c, int[] clen_p, byte[] m,
                                                           int mlen, byte[] ad, int adlen,
                                                           byte[] nsec, byte[] npub, byte[] k) {
        return SodiumJNI.crypto_aead_chacha20poly1305_encrypt(c, clen_p, m, mlen, ad, adlen, nsec
                , npub, k);
    }

    public static int crypto_aead_chacha20poly1305_encrypt_detached(byte[] c, byte[] mac,
                                                                    int[] maclen_p, byte[] m,
                                                                    int mlen, byte[] ad,
                                                                    int adlen, byte[] nsec,
                                                                    byte[] npub, byte[] k) {
        return SodiumJNI.crypto_aead_chacha20poly1305_encrypt_detached(c, mac, maclen_p, m, mlen,
    ...
    public static int crypto_aead_chacha20poly1305_decrypt(byte[] m, int[] mlen_p, byte[] nsec,
        ...
        return SodiumJNI.crypto_aead_chacha20poly1305_decrypt(m, mlen_p, nsec, c, clen, ad, adlen
                , npub, k);
    }

    public static int crypto_aead_chacha20poly1305_decrypt_detached(byte[] m, byte[] nsec,
                                                                    byte[] c, int clen,
                                                                    byte[] mac, byte[] ad,
                                                                    int adlen, byte[] npub,
                                                                    byte[] k) {
        return SodiumJNI.crypto_aead_chacha20poly1305_decrypt_detached(m, nsec, c, clen, mac, ad,
                adlen, npub, k);
    }
    ...
    public static int crypto_aead_chacha20poly1305_ietf_encrypt(byte[] c, int[] clen_p, byte[] m,
                                                                ...
                                                                byte[] nsec, byte[] npub,
                                                                byte[] k) {
        return SodiumJNI.crypto_aead_chacha20poly1305_ietf_encrypt(c, clen_p, m, mlen, ad, adlen,
                nsec, npub, k);
    }

    public static int crypto_aead_chacha20poly1305_ietf_encrypt_detached(byte[] c, byte[] mac,
                                                                         int[] maclen_p, byte[] m
            , int mlen, byte[] ad, int adlen, byte[] nsec, byte[] npub, byte[] k) {
        return SodiumJNI.crypto_aead_chacha20poly1305_ietf_encrypt_detached(c, mac, maclen_p, m,
                mlen, ad, adlen, nsec, npub, k);
    }

    public static int crypto_aead_chacha20poly1305_ietf_decrypt(byte[] m, int[] mlen_p,
                                                                byte[] nsec, byte[] c, int clen,
                                                                byte[] ad, int adlen, byte[] npub
            , byte[] k) {
        return SodiumJNI.crypto_aead_chacha20poly1305_ietf_decrypt(m, mlen_p, nsec, c, clen, ad,
                adlen, npub, k);
    }

    public static int crypto_aead_chacha20poly1305_ietf_decrypt_detached(byte[] m, byte[] nsec,
                                                                         byte[] c, int clen,
                                                                         byte[] mac, byte[] ad,
                                                                         int adlen, byte[] npub,
                                                                         byte[] k) {
        return SodiumJNI.crypto_aead_chacha20poly1305_ietf_decrypt_detached(m, nsec, c, clen, mac
                , ad, adlen, npub, k);
    }
    ...
    public static int crypto_aead_xchacha20poly1305_ietf_encrypt_detached(byte[] c, byte[] mac,
                                                                          int[] maclen_p,
                                                                          byte[] m, int mlen,
                                                                          byte[] ad, int adlen,
                                                                          byte[] nsec,
                                                                          byte[] npub, byte[] k) {
        return SodiumJNI.crypto_aead_xchacha20poly1305_ietf_encrypt_detached(c, mac, maclen_p, m,
                mlen, ad, adlen, nsec, npub, k);
    }

    public static int crypto_aead_xchacha20poly1305_ietf_encrypt(byte[] c, int[] clen_p, byte[] m
            , int mlen, byte[] ad, int adlen, byte[] nsec, byte[] npub, byte[] k) {
        return SodiumJNI.crypto_aead_xchacha20poly1305_ietf_encrypt(c, clen_p, m, mlen, ad, adlen
                , nsec, npub, k);
    }

    public static int crypto_aead_xchacha20poly1305_ietf_decrypt_detached(byte[] m, byte[] nsec,
                                                                          byte[] c, int clen,
                                                                          byte[] mac, byte[] ad,
                                                                          int adlen, byte[] npub,
                                                                          byte[] k) {
        return SodiumJNI.crypto_aead_xchacha20poly1305_ietf_decrypt_detached(m, nsec, c, clen,
                mac, ad, adlen, npub, k);
    }

    public static int crypto_aead_xchacha20poly1305_ietf_decrypt(byte[] m, int[] mlen_p,
                                                                 byte[] nsec, byte[] c, int clen,
                                                                 byte[] ad, int adlen,
                                                                 byte[] npub, byte[] k) {
        return SodiumJNI.crypto_aead_xchacha20poly1305_ietf_decrypt(m, mlen_p, nsec, c, clen, ad,
                adlen, npub, k);
    }
    ...
    public static int crypto_box_curve25519xsalsa20poly1305(byte[] c, byte[] m, int mlen,
    ...
    public static int crypto_generichash_blake2b_salt_personal(byte[] out, int outlen, byte[] in,
                                                               int inlen, byte[] key, int keylen,
                                                               byte[] salt, byte[] personal) {
        return SodiumJNI.crypto_generichash_blake2b_salt_personal(out, outlen, in, inlen, key,
                keylen, salt, personal);
    }
    ...
    public static int crypto_generichash_blake2b_init_salt_personal(byte[] state, byte[] key,
                                                                    ...
                                                                    byte[] salt, byte[] personal) {
        return SodiumJNI.crypto_generichash_blake2b_init_salt_personal(state, key, keylen, outlen
                , salt, personal);
    }
    ...
    public static int crypto_pwhash(byte[] out, int outlen, byte[] passwd, int passwdlen,
                                    byte[] salt, int opslimit, int memlimit, int alg) {
        return SodiumJNI.crypto_pwhash(out, outlen, passwd, passwdlen, salt, opslimit, memlimit,
                alg);
    }

    public static int crypto_pwhash_str(byte[] out, byte[] passwd, int passwdlen, int opslimit,
                                        int memlimit) {
    ...
    public static int crypto_pwhash_scryptsalsa208sha256(byte[] out, int outlen, byte[] passwd,
                                                         int passwdlen, byte[] salt, int opslimit
            , int memlimit) {
        return SodiumJNI.crypto_pwhash_scryptsalsa208sha256(out, outlen, passwd, passwdlen, salt,
                opslimit, memlimit);
    }

    public static int crypto_pwhash_scryptsalsa208sha256_str(byte[] out, byte[] passwd,
                                                             int passwdlen, int opslimit,
                                                             int memlimit) {
        return SodiumJNI.crypto_pwhash_scryptsalsa208sha256_str(out, passwd, passwdlen, opslimit,
                memlimit);
    }
    ...
    public static int crypto_pwhash_scryptsalsa208sha256_ll(byte[] passwd, int passwdlen,
                                                            byte[] salt, int saltlen, int N,
                                                            int r, int p, byte[] buf, int buflen) {
        return SodiumJNI.crypto_pwhash_scryptsalsa208sha256_ll(passwd, passwdlen, salt, saltlen,
                N, r, p, buf, buflen);
    }
    ...
    public static int crypto_secretbox_xsalsa20poly1305_open(byte[] m, byte[] c, int clen,
                                                             byte[] n, byte[] k) {
    ...
    public static int crypto_stream_chacha20_xor_ic(byte[] c, byte[] m, int mlen, byte[] n,
                                                    int ic, byte[] k) {
    ...
    public static int crypto_stream_xsalsa20_xor_ic(byte[] c, byte[] m, int mlen, byte[] n,
                                                    int ic, byte[] k) {
    ...
    public static int crypto_secretstream_xchacha20poly1305_init_push(byte[] state, byte[] header
            , byte[] k) {
        return SodiumJNI.crypto_secretstream_xchacha20poly1305_init_push(state, header, k);
    }

    public static int crypto_secretstream_xchacha20poly1305_push(byte[] state, byte[] c,
                                                                 int[] clen_p, byte[] m, int mlen
            , byte[] ad, int adlen, short tag) {
        return SodiumJNI.crypto_secretstream_xchacha20poly1305_push(state, c, clen_p, m, mlen, ad
                , adlen, tag);
    }

    public static int crypto_secretstream_xchacha20poly1305_init_pull(byte[] state, byte[] header
            , byte[] k) {
        return SodiumJNI.crypto_secretstream_xchacha20poly1305_init_pull(state, header, k);
    }

    public static int crypto_secretstream_xchacha20poly1305_pull(byte[] state, byte[] m,
                                                                 int[] mlen_p, byte[] tag_p,
                                                                 byte[] c, int clen, byte[] ad,
                                                                 int adlen) {
        return SodiumJNI.crypto_secretstream_xchacha20poly1305_pull(state, m, mlen_p, tag_p, c,
                clen, ad, adlen);
    }
    ...
    public static int crypto_box_curve25519xchacha20poly1305_seed_keypair(byte[] pk, byte[] sk,
                                                                          byte[] seed) {
    ...
    public static int crypto_box_curve25519xchacha20poly1305_beforenm(byte[] k, byte[] pk,
                                                                      byte[] sk) {
        return SodiumJNI.crypto_box_curve25519xchacha20poly1305_beforenm(k, pk, sk);
    }

    public static int crypto_box_curve25519xchacha20poly1305_detached_afternm(byte[] c,
                                                                              byte[] mac,
                                                                              byte[] m, int mlen,
                                                                              byte[] n, byte[] k) {
        return SodiumJNI.crypto_box_curve25519xchacha20poly1305_detached_afternm(c, mac, m, mlen,
                n, k);
    }

    public static int crypto_box_curve25519xchacha20poly1305_detached(byte[] c, byte[] mac,
                                                                      byte[] m, int mlen,
                                                                      byte[] n, byte[] pk,
                                                                      byte[] sk) {
        return SodiumJNI.crypto_box_curve25519xchacha20poly1305_detached(c, mac, m, mlen, n, pk,
                sk);
    }

    public static int crypto_box_curve25519xchacha20poly1305_easy_afternm(byte[] c, byte[] m,
                                                                          int mlen, byte[] n,
                                                                          byte[] k) {
        return SodiumJNI.crypto_box_curve25519xchacha20poly1305_easy_afternm(c, m, mlen, n, k);
    }

    public static int crypto_box_curve25519xchacha20poly1305_easy(byte[] c, byte[] m, int mlen,
                                                                  byte[] n, byte[] pk, byte[] sk) {
        return SodiumJNI.crypto_box_curve25519xchacha20poly1305_easy(c, m, mlen, n, pk, sk);
    }

    public static int crypto_box_curve25519xchacha20poly1305_open_detached_afternm(byte[] m,
                                                                                   byte[] c,
                                                                                   byte[] mac,
                                                                                   int clen,
                                                                                   byte[] n,
                                                                                   byte[] k) {
        return SodiumJNI.crypto_box_curve25519xchacha20poly1305_open_detached_afternm(m, c, mac,
                clen, n, k);
    }

    public static int crypto_box_curve25519xchacha20poly1305_open_detached(byte[] m, byte[] c,
                                                                           byte[] mac, int clen,
                                                                           byte[] n, byte[] pk,
                                                                           byte[] sk) {
        return SodiumJNI.crypto_box_curve25519xchacha20poly1305_open_detached(m, c, mac, clen, n,
                pk, sk);
    }

    public static int crypto_box_curve25519xchacha20poly1305_open_easy_afternm(byte[] m, byte[] c
            , int clen, byte[] n, byte[] k) {
        return SodiumJNI.crypto_box_curve25519xchacha20poly1305_open_easy_afternm(m, c, clen, n, k);
    }

    public static int crypto_box_curve25519xchacha20poly1305_open_easy(byte[] m, byte[] c,
                                                                       int clen, byte[] n,
                                                                       byte[] pk, byte[] sk) {
        return SodiumJNI.crypto_box_curve25519xchacha20poly1305_open_easy(m, c, clen, n, pk, sk);
    }

    public static int crypto_box_curve25519xchacha20poly1305_seal(byte[] c, byte[] m, int mlen,
                                                                  byte[] pk) {
        return SodiumJNI.crypto_box_curve25519xchacha20poly1305_seal(c, m, mlen, pk);
    }

    public static int crypto_box_curve25519xchacha20poly1305_seal_open(byte[] m, byte[] c,
                                                                       int clen, byte[] pk,
                                                                       byte[] sk) {
